...
const Alphabets: React.FC<Props> = ({ onBack }) => {
  ...
  const alphabetList = (alphabetsData[lang] || alphabetsData['English'] || []) as any[];
            ...
            >
              {alphabetList.length === 0 && (
                <div className="col-span-full py-20 text-center">
                   <p className="text-2xl font-black text-slate-300">Oops! No letters found. 🎈</p>
                </div>
              )}
              {alphabetList.map((a, idx) => (
                <motion.button
                  key={a.char}
